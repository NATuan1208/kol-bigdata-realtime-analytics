...
# để mỗi consumer ĐỀUỀU nhận được message (không phải load-balance)
CONSUMER_GROUPS = {
    "video_stats_worker": "kol-video-stats-worker",
    "comment_extractor": "kol-comment-extractor",
    "product_extractor": "kol-product-extractor",
    "profile_enricher": "kol-profile-enricher",
}
